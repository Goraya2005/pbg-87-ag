...
const sections: Section[] = [
  ...
  },
  {
    ...
    images: ['12.jpg', '11.jpg', '10.jpg', '9.jpg', '8.jpg', '7.jpg', '6.jpg', '5.jpg', '4.jpg', '3.jpg', '2.jpg', '1.jpg'],
  },
  {
    date: 'August 24, 2024',
  ...
  },
  {
    ...
    images: ['1a.jpeg', '1b.jpeg', '1c.jpeg', '1d.jpeg', '1e.jpeg', '1f.jpeg', '1g.jpeg', '1h.jpeg', '1j.jpeg', '1m.jpeg', '1l.jpeg'],
  },
];
    ...
    <div className="max-w-7xl mx-auto">
      ...
      {sections.map(({ date, folder, images }, idx) => (
        <div key={idx} className="mb-16">
          <h2 className="text-2xl text-gray-500 text-center mb-8">Date of Meeting: {date}</h2>
